...
class CoachCommentsPageOld extends React.Component<IProps, IStates> {
  ...
  componentDidMount() {
    this.urlDailyProgram = "/coach/dashboard/daily-program/" + this.state.classId;
    this.urlEnterComment = "/coach/dashboard/enter-comments/" + this.state.classId;
    this.authFromLocal();
  }
...
const mapStateToProps = ({
  authUser,classes,response
}: StoreState): {
  authUser: AuthInterface;classes : any;response : any;
} => {
  return {
    authUser,classes,response
  };
...
export default connect(mapStateToProps, { getClassObject,getAll})(CoachCommentsPageOld);
