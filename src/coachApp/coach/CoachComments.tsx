...
class CoachCommentsPage extends React.Component<IProps, IStates> {
  ...
  componentDidMount() {
    this.urlDailyProgram = "/coache/dashboard/daily-program/" + this.state.classId;
    this.urlEnterComment = "/coache/dashboard/enter-comments/" + this.state.classId;
    this.authFromLocal();
  }
...
export default connect(mapStateToProps, { getClassObject,getAll})(CoachCommentsPage);
