...
interface CoachRecoverPasswordPage {
	recoverPassword: Function;
	authUser: AuthInterface;
}

type IProps = CoachRecoverPasswordPage;

class CoachRecoverPasswordPage extends React.Component<IProps, IStates> {
