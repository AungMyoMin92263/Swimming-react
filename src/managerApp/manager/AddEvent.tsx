...
class AddEvent extends React.Component<IProps, IStates> {
  ...
  isValid = () => {
    ...
    if (
      !this.state.event.name || this.state.event.name.length === 0 ||
      !this.state.event.stroke || this.state.event.stroke.length === 0 ||
      ...
      case "female": {
        return (
          <div className="tab">
            ...
            <div className="tab-item-selected" onClick={() => this.setTab("Female")}>
              <span>Female</span>
            </div>
            <div className="tab-item" onClick={() => this.setTab("Mixed")}>
              <span>Mixed</span>
      ...
      case "mixed": {
        return (
          <div className="tab">
            ...
            <div className="tab-item-selected" onClick={() => this.setTab("Mixed")}>
              <span>Mixed</span>
            </div>
          </div>
        );
  ...
  render() {
    const { event, EventNameMsg } = this.state;
    return (
      <>
