...
class AdminInviteStudent extends React.Component<IProps, IStates> {
  url: any;
  backUrl: any;
  id: any;
  schoolId: any;
  ...
  componentDidMount() {
    ...
    if (!this.id) {
      ...
      if (classObject) {
        ...
        this.url = "/admin/school/"+this.schoolId +"/invite-student-summary/new/" + classObject.id;
      }
      this.backUrl = "/admin/school/"+this.schoolId+"/invite-coach";
    } else {
      this.url = "/admin/school/"+this.schoolId +"/invite-student-summary/" + this.id;
      this.backUrl = "/admin/school/"+this.schoolId +"/invite-student-summary/" + this.id;
      this.getClass();
    }
    this.getSchool();
  }
            ...
            <div className="content col-lg-6">
              <div className="f-14 mb-32">
                <Link
                  to={
                    this.id
                      ? "/admin/school/"+this.schoolId +"/invite-student-summary/" + this.id
                      :"/admin/school/"+this.schoolId +"/invite-coach-summary"
                  }
