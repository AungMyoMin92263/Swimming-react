...
class AdminSetDateTime extends React.Component<IProps, IStates> {
	id : any;schoolId:any;
		...
		if (this.isValid()) {
			...
			if (this.props.classes.error) {
				...
				if (this.props.classes.result && this.props.classes.result.data) {
					...
					this.id = this.props.classes.result.data.id;
					this.setState({
						isCompleted: true,
					});
				}
			...
			<>
				<div className='wrapper'>
					{this.state.isCompleted === true && (
						<Navigate to={'/admin/school/'+ this.schoolId +'/invite-coach/'+ this.id} replace={true} />
					)}
