...
import {
  ...
  putClass,
  getClassObject,
  LoadingActionFunc,getSchoolObj,
} from "../../stores/actions";
// icon
...
class AdminEditClass extends React.Component<IProps, IStates> {
  id: any;
  schoolId: any;
  ...
  getClass = async () => {
    await this.props.getClassObject(
      "school/" + this.schoolId + "/class/" + this.id
    );
      ...
      return (
        <>
          {this.state.isCompleted && (
            <Navigate
              to={"/admin/school/"+this.schoolId+"/edit-set-date-time/" + this.state.classObj.id}
              replace={true}
            />
          )}
  ...
  render() {
    const { classObj, school_name, errorMsg } = this.state;
          ...
          <div className="container-cus">
            <div className="content col-6 col-md-6 col-sm-12">
              <div className="f-14 mb-32">
                <Link to={"/admin/school/"+this.schoolId+"/class/"+this.id} style={{ textDecoration: "none" }}>
                  <ArrowBackIcon
