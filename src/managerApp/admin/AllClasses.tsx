...
import { signOut, LoadingActionFunc, getSchoolObj } from "../../stores/actions";
...
class AllClassesPage extends React.Component<IProps, IStates> {
  url = "/admin/class/";
  id : any;
          ...
          <div className="createClass flex-center">
            <div className="body">
              ...
              <div className="flex-center mt-16">
                <Link to={"/admin/add-class/"+this.state.school_id}>
                  <button
                    type="submit"
