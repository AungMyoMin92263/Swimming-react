...
import { getClassObject } from "./../../stores/actions";
...
class ParentBookingAlert extends React.Component<IProps, IStates> {
  id: any;
  minuteObj: any = {
    first_slot: 0,
    second_slot: 10,
        ...
        <div className="wrapper-mobile">
          <div className="content-mobile-cus-space bg-w col-sm-12">
            ...
            <div className="text-center">
              <div className="f-32 fw-500 pt-40 mb-16">
                <span>This slot has been already booked.</span>
              </div>
              <div className="f-14 mb-32">
                <span>Select another slot or try booking for the next class.</span>
              </div>
              {slot && classe && (
                <div className="mb-32">
                  <ListItem
...
export default connect(mapStateToProps, {getClassObject})(ParentBookingAlert);
