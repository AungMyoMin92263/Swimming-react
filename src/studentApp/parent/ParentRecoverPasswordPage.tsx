...
interface ParentRecoverPasswordPage {
	recoverPassword: Function;
	authUser: AuthInterface;
}

type IProps = ParentRecoverPasswordPage;

class ParentRecoverPasswordPage extends React.Component<IProps, IStates> {
