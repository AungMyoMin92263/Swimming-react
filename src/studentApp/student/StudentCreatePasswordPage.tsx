...
interface StudentCreatePasswordPage {
	signUp: Function;
	signedUpUser: SignedUpInterface;
}

type IProps = StudentCreatePasswordPage;

class StudentCreatePasswordPage extends React.Component<IProps, IStates> {
...
export default connect(mapStateToProps, { signUp })(StudentCreatePasswordPage);
