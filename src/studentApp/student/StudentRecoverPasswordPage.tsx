...
interface StudentRecoverPasswordPage {
	recoverPassword: Function;
	authUser: AuthInterface;
}

type IProps = StudentRecoverPasswordPage;

class StudentRecoverPasswordPage extends React.Component<IProps, IStates> {
